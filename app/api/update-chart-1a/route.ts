  ...
  try {
    ...
    const oficialPricesRef = await db
      ...
      .where(
        'timestamp',
        '>=',
        admin.firestore.Timestamp.fromDate(pastYearDate)
      )
    ...
    await db
      ...
      .set(
        {
          '1a': oficialPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
    ...
    await db
      ...
      .set(
        {
          '1a': bluePricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '1a': mepPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '1a': cocosPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '1a': tarjetaPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '1a': mayoristaPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '1a': cclPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '1a': criptoPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    return new Response('1A Updated', {
      status: 200,
    })
  } catch (error: unknown) {
