  ...
  try {
    ...
    const oficialPricesRef = await db
      ...
      .where(
        'timestamp',
        '>=',
        admin.firestore.Timestamp.fromDate(past2YearsData)
      )
    ...
    await db
      ...
      .set(
        {
          '2a': oficialPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
    ...
    await db
      ...
      .set(
        {
          '2a': bluePricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '2a': mepPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '2a': cocosPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '2a': tarjetaPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '2a': mayoristaPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '2a': cclPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '2a': criptoPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    return new Response('2A Updated', {
      status: 200,
    })
  } catch (error: unknown) {
