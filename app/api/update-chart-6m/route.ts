  ...
  try {
    ...
    const oficialPricesRef = await db
      ...
      .where(
        'timestamp',
        '>=',
        admin.firestore.Timestamp.fromDate(past6MonthsDate)
      )
    ...
    await db
      ...
      .set(
        {
          '6m': oficialPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
    ...
    await db
      ...
      .set(
        {
          '6m': bluePricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '6m': mepPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '6m': cocosPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '6m': tarjetaPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '6m': mayoristaPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '6m': cclPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    await db
      ...
      .set(
        {
          '6m': criptoPricesPerDayArray.map((item: any) => ({
            ask: item.ask,
            timestamp: item.timestamp,
          })),
        },
    ...
    return new Response('6M Updated', {
      status: 200,
    })
  } catch (error: unknown) {
