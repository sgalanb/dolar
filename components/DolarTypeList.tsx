  ...
  return (
    <Link
      ...
      className={`${
        ...
        dolarType.ask ? 'grid grid-cols-[104px,1fr,100px] grid-rows-1' : 'flex'
      } h-20 w-full items-center gap-3 rounded-2xl bg-white p-3 shadow dark:bg-zinc-800 dark:shadow-none md:h-[5.15625rem]`}
    >
      {dolarType.ask ? (
        <>
        ...
        <div className="h-full w-full animate-pulse rounded-md bg-[#F3F4F6] dark:bg-[#71717A]/50" />
      )}
    </Link>
  )
}
